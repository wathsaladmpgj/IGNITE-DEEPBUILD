            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                    ...
                    <button
                        ...
                        className="mt-2 flex items-center gap-2 px-4 py-2 bg-indigo-50 text-indigo-700 hover:bg-indigo-100 rounded-md text-sm font-semibold transition border border-indigo-200 disabled:opacity-50"
                    >
                    ...
                    {/* THE AI RESPONSE BOX */}
                    {aiSuggestion && (
                        <div className="mt-4 p-4 bg-gradient-to-r from-indigo-50 to-blue-50 rounded-lg border border-indigo-100 shadow-inner">
